...
class AddRecipeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const _AddRecipeScreenContent();
  }
}
class _AddRecipeScreenContent extends StatelessWidget {
  const _AddRecipeScreenContent();
...
class _AddRecipeForm extends StatelessWidget {
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 24),
            Consumer<RecipeState>(
              builder: (context, state, child) => _buildDietTagsSection(context, state, controller),
            ),
            const SizedBox(height: 24),
            _buildNutritionSection(state),
            const SizedBox(height: 24),
            Consumer<RecipeState>(
              builder: (context, state, child) => _buildIngredientsSection(context, state, controller),
            ),
            const SizedBox(height: 24),
            Consumer<RecipeState>(
              builder: (context, state, child) => _buildInstructionsSection(context, state, controller),
            ),
            const SizedBox(height: 24),
  ...
  Widget _buildDietTagsSection(BuildContext context, RecipeState state, AddRecipeController controller) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
  ...
  Widget _buildIngredientsSection(BuildContext context, RecipeState state, AddRecipeController controller) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
  ...
  Widget _buildIngredientCard(BuildContext context, IngredientState ingredient, int index, AddRecipeController controller) {
    return Card(
  ...
  Widget _buildInstructionsSection(BuildContext context, RecipeState state, AddRecipeController controller) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
  ...
  Widget _buildInstructionCard(BuildContext context, TextEditingController instruction, int index, AddRecipeController controller) {
    return Card(
      margin: const EdgeInsets.only(bottom: 12),
      elevation: 0,
      shape: RoundedRectangleBorder(
  ...
  Widget _buildSaveButton(BuildContext context, AddRecipeController controller) {
    return SizedBox(
